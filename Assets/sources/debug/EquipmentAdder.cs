...
namespace PataRoad.AppDebug
{
    class EquipmentAdder : MonoBehaviour
    {
        ...
        public void AddAllEquipments()
        {
            ...
            {
                var weaponName = Core.Character.Class.ClassAttackEquipmentData
                    .GetEquipmentName(cl, Core.Character.Equipments.EquipmentType.Weapon);
                var protectorName = Core.Character.Class.ClassAttackEquipmentData
                    .GetEquipmentName(cl, Core.Character.Equipments.EquipmentType.Protector);
